...
| Area | Stack |
|---|---|
| **AWS architecture** | Lambda · DynamoDB · CloudFront · Step Functions · EventBridge · Cognito · KMS |
| **Generative AI** | Amazon Bedrock · Claude · prompt caching · RAG · vector databases |
| **Containers & K8s** | Kubernetes (CKA · CKAD · CKS) · ArgoCD · Helm · Karpenter |
| **Infrastructure as Code** | Terraform · `terraform-aws-modules/*` · GitHub Actions OIDC |
| **Security & compliance** | DKIM strict · DNSSEC · MTA-STS · WAFv2 OWASP · NIS2 · DORA · GDPR |
| **MLOps** | SageMaker · MLflow · vector DBs · model deployment |
| **iOS** | Swift · SwiftUI · StoreKit 2 |

## Career highlights

- **ProcessControl** &mdash; Tech Lead, DevOps & MLOps (Jul 2024 — present)
- **Seqera** &mdash; DevOps Lead / DevSecOps Engineer (Jun 2022 — Jun 2024)
- **Santander Global Tech** &mdash; Senior DevOps Automation Engineer (May 2020 — May 2022)
- **Payvision · BNP Paribas · Inditex · Microsoft** &mdash; DevOps roles (2016–2020)

## Certifications · 15 active

**AWS** Solutions Architect · Developer · SysOps · Security Specialty · Advanced Networking ·
**CNCF** CKA · CKAD · CKS · KCNA ·
**HashiCorp** Terraform Associate · Vault Associate ·
**Docker** Certified Associate ·
**Microsoft** MCSE Cloud · MCSA Server 2012 ·
